<template>
  <section>
      ...
      <nav class="border-t border-gray-200 px-4 flex items-center relative sm:px-0">
        <a v-if="hasPreviousPage"
           @click.prevent="previousPage"
           alt="Load the previous page of users"
           href="#"
           class="lc-previous mr-auto border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 md:absolute"
        >
        ...
        <div class="hidden md:mx-auto md:-mt-px md:flex">
        ...
        <a v-if="hasNextPage"
           ...
           href="#"
           class="lc-next ml-auto right-0 border-t-2 border-transparent pt-4 pl-1 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 md:absolute"
        >
          Next
